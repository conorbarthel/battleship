...
#No argumetns taken
  def initialize()
    ...
    c_cruiser = Ship.new("Cpu_Cruiser", 3)
    p_submarine = Ship.new("Submarine", 2)
    c_submarine = Ship.new("Cpu_Submarine", 2)
...
#Creates a method that can be run in the runner file
  def new_game
    initialize
    welcome_message
  end

#Prints welcome message and either starts game or replays method
  def welcome_message
  ...
  def place_instructions
    ...
    "Now it is your turn to lay out your ships. " +
    "The cruiser is 3 units long and the submarine is 2 units \n \n"
